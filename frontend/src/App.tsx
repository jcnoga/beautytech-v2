...
const THEMES: Record<string, any> = {
  noir: {
    name: "Noir", icon: "◆",
    bg:"#0C0A09", card:"#141210", surface:"#1A1714", border:"#2A2420", borderHi:"#3D3028",
    rose:"#E8A598", roseDeep:"#C4766A", roseDim:"#E8A59820",
    gold:"#D4AF7A", goldDeep:"#B8924A", goldDim:"#D4AF7A18",
    cream:"#F5EDD8", sage:"#8FAF8A", sapphire:"#6B8CAE", ruby:"#C4606A",
    text:"#F0E8DC", textSec:"#C4A882", textMuted:"#6B5A48",
    overlay:"rgba(12,10,9,0.85)",
    fd:"'Playfair Display', serif", fb:"'Outfit', sans-serif",
  },
  sakura: {
    name: "Sakura", icon: "✿",
    bg:"#FDF6F8", card:"#FFFFFF", surface:"#FFF0F3", border:"#F5D5DC", borderHi:"#EBB8C3",
    rose:"#D4637A", roseDeep:"#B84860", roseDim:"#D4637A18",
    gold:"#C4956A", goldDeep:"#A87850", goldDim:"#C4956A18",
    cream:"#4A3040", sage:"#5A8F6A", sapphire:"#5878A8", ruby:"#C43050",
    text:"#2A1820", textSec:"#6A3848", textMuted:"#B898A8",
    overlay:"rgba(253,246,248,0.92)",
    fd:"'Playfair Display', serif", fb:"'Outfit', sans-serif",
  },
  dourado: {
    name: "Dourado", icon: "★",
    bg:"#FAFAF7", card:"#FFFFFF", surface:"#F7F5F0", border:"#E8E0D0", borderHi:"#D4C8A8",
    rose:"#B8924A", roseDeep:"#9A7830", roseDim:"#B8924A18",
    gold:"#C8A050", goldDeep:"#A88030", goldDim:"#C8A05018",
    cream:"#3A3020", sage:"#607850", sapphire:"#506880", ruby:"#A84040",
    text:"#2A2010", textSec:"#6A5830", textMuted:"#B0A080",
    overlay:"rgba(250,250,247,0.92)",
    fd:"'Cormorant Garamond', serif", fb:"'Outfit', sans-serif",
  },
  esmeralda: {
    name: "Esmeralda", icon: "◈",
    bg:"#0A120E", card:"#111A14", surface:"#182218", border:"#243028", borderHi:"#304038",
    rose:"#7AC8A0", roseDeep:"#58A880", roseDim:"#7AC8A020",
    gold:"#D4AF7A", goldDeep:"#B8924A", goldDim:"#D4AF7A18",
    cream:"#E8F5EE", sage:"#A8D8B8", sapphire:"#6898B8", ruby:"#C87868",
    text:"#E0F0E8", textSec:"#A0C8B0", textMuted:"#506858",
    overlay:"rgba(10,18,14,0.88)",
    fd:"'Playfair Display', serif", fb:"'Outfit', sans-serif",
  },
  violeta: {
    name: "Violeta", icon: "◉",
    bg:"#0E0A14", card:"#150F1E", surface:"#1C1428", border:"#2A2038", borderHi:"#382C4C",
    rose:"#C898E8", roseDeep:"#A870D0", roseDim:"#C898E820",
    gold:"#E8C878", goldDeep:"#D0A848", goldDim:"#E8C87818",
    cream:"#F0E8FF", sage:"#90B890", sapphire:"#7898D8", ruby:"#D86878",
    text:"#F0E8FF", textSec:"#C0A8E0", textMuted:"#705888",
    overlay:"rgba(14,10,20,0.88)",
    fd:"'Playfair Display', serif", fb:"'Outfit', sans-serif",
  },
  auto: {
    name: "Auto", icon: "◑",
    bg:"", card:"", surface:"", border:"", borderHi:"",
    rose:"", roseDeep:"", roseDim:"",
    gold:"", goldDeep:"", goldDim:"",
    cream:"", sage:"", sapphire:"", ruby:"",
...
const getSavedTheme = () => {
  const t = localStorage.getItem("beautytech_theme") ?? "noir";
  return t === "auto" ? "auto" : (THEMES[t] ? t : "noir");
};

const resolveTheme = (themeId: string) => {
  if (themeId === "auto") return THEMES[getSystemTheme()];
  return THEMES[themeId] ?? THEMES.noir;
};

// Tema ativo — atualizado dinamicamente
let _themeId = getSavedTheme();
let _T = resolveTheme(_themeId);
let C = _T;
let FD = _T.fd;
let FB = _T.fb;

// Subscriber para mudança de tema
type ThemeListener = () => void;
const themeListeners: ThemeListener[] = [];
const setGlobalTheme = (id: string) => {
  _themeId = id;
  localStorage.setItem("beautytech_theme", id);
  _T = resolveTheme(id);
  C = _T;
  FD = _T.fd;
  FB = _T.fb;
...
const useTheme = () => {
  ...
  useEffect(() => {
    ...
    // Detectar mudança automática do SO
    const mq = window.matchMedia("(prefers-color-scheme: dark)");
    const mqFn = () => { if (_themeId === "auto") { C = resolveTheme("auto"); FD = C.fd; FB = C.fb; forceUpdate(n => n + 1); } };
